package com.example.doni.ruokalistajson;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG_RESTAURANT_URL = "RestaurantUrl";
    private static final String TAG_PRICE_HEADER = "PriceHeader";
    ...
    private static final String TAG_ERROR_TEXT = "ErrorText";
    private static final String TAG_OBJECT = "Object";
    private static final String TAG_NEW_DAY ="NewDay";
    ...
    private static String url = "http://www.amica.fi/modules/json/json/Index?costNumber=0235&language=fi";
    //private static String url = "http://www.amica.fi/modules/json/json/Index?costNumber=0235&language=fi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lTime = (TextView) findViewById(R.id.lunchtime);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < menusForDays.length(); i++) {
                        ...
                        if(c.getString("LunchTime").equals("Kotkanpoika kello:  10.15 - 13.00 Kultturelli kello: 10.30 - 14.00")){
                            JSONObject f = menusForDays.getJSONObject(0);
                            f.put("Date", "Tänään");
                        }
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    new int[]{R.id.name, R.id.lunchtime, R.id.components, R.id.date});
